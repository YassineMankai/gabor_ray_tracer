...
public:
	 ...
	 */
	inline glm::mat4 computeViewMatrix () const { return inverse (glm::mat4_cast (curQuat) * computeTransformMatrix (true)); }
...
private:
	...
	float m_far = 200.f; // Distance after which the geometry is excluded fromt he rasterization process
	glm::quat curQuat;
	glm::quat lastQuat;
};
