...
public:
	...
	inline glm::mat4 computeTransformMatrix (bool isCamera = false) const {
		if (isCamera) {
			glm::mat4 id(1.0);
			...
			glm::mat4 id(1.0);
			glm::mat4 t = glm::translate(id, m_translation);
			glm::mat4 rt = glm::rotate(t, m_rotation[2], glm::vec3(0.0, 0.0, 1.0));
			rt = glm::rotate(rt, m_rotation[1], glm::vec3(0.0, 1.0, 0.0));
			rt = glm::rotate(rt, m_rotation[0], glm::vec3(1.0, 0.0, 0.0));
			glm::mat4 trsm = glm::scale(rt, glm::vec3(m_scale));
			return trsm;
		}
	}
